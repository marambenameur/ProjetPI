 ...
 * @author OussKh
 */
public class MenuAdherantController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/SideBarAdherant.fxml"));
            Parent root;
            root = loader.load();
    ...
    {
        email.setText(text);
        String requete="SELECT * FROM adherant Where email ='" + email.getText() + "'";
            try {
    ...
    private void ModifMotdePass(MouseEvent event) throws IOException {
          FXMLLoader loader  = new FXMLLoader(getClass().getResource("/GUI/ResetAdherant.fxml"));
          Parent root =loader.load();
          ResetAdherantController second =loader.getController();
