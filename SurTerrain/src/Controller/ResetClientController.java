 ...
 * @author OussKh
 */
public class ResetClientController implements Initializable {
    ...
    ServiceClient adherant =new ServiceClient();
    /**
          ...
          if (adherant.findByPass(ancien.getText())==  true)
        {
            ...
            Optional<ButtonType> action = alertA.showAndWait();
                                                   if (action.get() == ButtonType.OK) {
                                                                  Parent roott =FXMLLoader.load(getClass().getResource("/GUI/SideMenu.fxml")); 
